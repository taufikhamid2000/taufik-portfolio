...
import '../../../../styles/commonStyles.css'; // Adjust the import path based on your structure
    ...
    <div className="min-h-screen bg-white text-black dark:bg-gray-900 dark:text-white">
      ...
      <div className="pt-20 w-full max-w-6xl mx-auto p-8">
        ...
        <div className="mb-6 flex justify-between">
          <Link href="/projects/Veyoyee/create-survey">
              ...
              surveys.length > 0
                ? surveys.map((survey) => ({
                    cols: [
                      ...
                      survey.responses,
                      <>
                        <Button text="View" color="yellow" className= "button-class" />
