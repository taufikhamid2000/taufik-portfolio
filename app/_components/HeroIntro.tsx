...
export default function HeroIntro() {
  ...
  return (
    <section className="relative mb-10 overflow-hidden dark:rounded-3xl dark:border dark:border-white/10 dark:bg-white/[0.03] dark:p-5 md:mb-16 md:dark:p-10 dark:backdrop-blur-xl">
