...
export default async function SprintDetailPage({ params, searchParams }: SprintDetailPageProps) {
  ...
  return (
    <div>
      ...
      {/* Sprint header card */}
      <Reveal>
        <TiltWrapper className="rounded-lg dark:rounded-2xl mb-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {COLUMNS.map((col, i) => (
          <Reveal key={col.status} delay={i * 80}>
            <div className="border border-gray-200 dark:border-white/10 rounded-lg dark:rounded-2xl p-3 min-h-[200px] bg-gray-50/50 dark:bg-white/[0.02] dark:backdrop-blur-xl">
